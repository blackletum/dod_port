...
For example, you might have the following file structure:
	...
	dod/custom/my_custom_stuff/   <<< This subfolder will be added as a search path
	dod/custom/my_custom_stuff/models/custom_model.mdl
	dod/custom/my_custom_stuff/materials/custom_material.vmt
	dod/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	dod/custom/some_mod.vpk       <<< This VPK will be added as a search path
	dod/custom/another_mod.vpk    <<< This VPK will be added as a search path
...
Note that the following directory structure is NOT correct:
	...
	dod/custom/models/my_model.mdl

That will add the directory "dod/custom/models" as a search path, in which case the
